...
def defense():
  ...
  print "I claim all one need do to become a master of any task, skill, or way is to love it.  And I also claim that without love, you will never be a master, no matter how capable you are."
...
def conclusion():
  ...
  print "However I believe the similarities I stated in my defense provide the correct recipe for comparison."
